...
<pre class='in'><code>#If you're a GUI user and having trouble navigating to the file, you can also use a point and click approach to directly load this file from your file system
carSpeeds <- read.csv(file.choose())
head(carSpeeds) </code></pre>



<pre class='in'><code>#If you get stuck, you can download the file directly from the internet
carSpeeds <- read.csv(file='https://raw.githubusercontent.com/cbahlai/2015-01-05-wise-umich/gh-pages/novice/r/car-speeds.csv')
head(carSpeeds) </code></pre>
